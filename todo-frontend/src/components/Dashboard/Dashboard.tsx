...
const Dashboard: React.FC = () => {
  ...
  }, [pagination.page, pagination.limit, toast, clearAuth]);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="sticky top-8">
            {quote && (
              <div className="p-8 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl shadow-sm border border-gray-100 h-full">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-2xl italic text-gray-800 leading-relaxed">"{quote.text}"</p>
